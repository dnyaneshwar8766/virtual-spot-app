...
import { CheckCircle, Play, Trash2, Clock, Users, Crown } from "lucide-react";
...
export function AdminQueueTable({ entries, onServing, onServed, onRemove }: AdminQueueTableProps) {
  ...
  return (
    <div className="space-y-3">
      {all.map((entry, i) => {
        const isPriority = (entry as any).priority === "priority";
        return (
          <div
            key={entry.id}
            ...
            } ${isPriority ? "border-l-4 border-l-warning" : ""}`}
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-3 text-xs text-muted-foreground mt-0.5">
                ...
                {entry.notes && <span className="text-warning">📝 Has notes</span>}
              </div>
            </div>
            ...
            <div className="flex items-center gap-1 shrink-0">
              ...
              />
              <CustomerHistoryDialog customerName={entry.customer_name} />
